export default function About() {
  return (
    <div>
      ...
      <br/>
      <p>There are two main modes offered in TypingJerboa: Learn, and Race.</p>
      <br/>
      ...
      <br/>
        <a target="_blank" href="https://github.com/DanielGroelle/TypingJerboa" className="underline flex">
          <img className="bg-white mr-1" width="24" alt="GitHub Invertocat Logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/GitHub_Invertocat_Logo.svg/256px-GitHub_Invertocat_Logo.svg.png"></img>
          TypingJerboa GitHub
        </a>
    </div>
  );
